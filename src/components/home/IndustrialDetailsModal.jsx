...
const IndustrialDetailsModal = ({ industrial, isOpen, onClose, onPurchaseSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg w-full max-w-7xl max-h-[90vh] overflow-auto relative">
        ...
        {/* Industrial Product Details Component */}
...
const IndustrialProductDetails = ({ industrial, onPurchaseSuccess }) => {
  ...
  const handleAddToCart = useCallback(async () => {
    ...
    try {
      ...
      alert(`Added ${quantity} ${industrial.name} to cart successfully!`);
  ...
  }, [industrial, quantity, addToCart, isAuthenticated, onPurchaseSuccess]);
...
export default IndustrialDetailsModal;